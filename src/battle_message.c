...
const u8 gText_BattleMenu[] = _("Battle{CLEAR_TO 56}Catch\nPokémon{CLEAR_TO 56}Run");
const u8 gText_BattleMenuCatchDisabled[] =  _("Battle{CLEAR_TO 56}{COLOR 11}Catch\n{COLOR 13}Pokémon{CLEAR_TO 56}Run");
