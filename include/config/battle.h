...
#define B_PROTEAN_LIBERO                GEN_6_XY   // In Gen9+, Protean and Libero trigger only once per Battle.
...
#define B_LAST_USED_BALL            FALSE      // If set to TRUE, the "last used Ball" feature from Gen7+ will be implemented
